...
def main(args):
    ...
    if args.loss == "dice": # 1 - dice_score
        criterion = monai.losses.DiceLoss() 
    elif args.loss == "BCE": # binary cross entropy
        criterion = nn.BCELoss()
    elif args.loss == "dicebce": # combined loss
        bce_loss = nn.BCELoss()
...
if __name__ == '__main__':
    ...
    # experiment 1: unet_dice_loss_mobilenet_v2_1.0_1.0 (not good enough)
    # experiment 2: unet_dice_loss_mobilenet_v2_1.0_5.0 (better)
    # experiment 3: unet_bce_loss_mobilenet_v2_1.0_5.0 (bettere)
    # experiment 4: unet_dice_loss_resnet101_1.0_5.0 (not good enough)
    # experiment 5: unet_dicebce_loss_resnet101_1.0_5.0 (best)
